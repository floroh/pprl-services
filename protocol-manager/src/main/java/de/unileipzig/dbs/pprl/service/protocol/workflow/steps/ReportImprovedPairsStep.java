...
public class ReportImprovedPairsStep extends ProcessingStep {

  public ReportImprovedPairsStep() {
    this.type = getStepType().toString();
  }

  public ReportImprovedPairsStep(String type, Map<String, String> properties,
  ...
  public static StepType getStepType() {
    return MultiLayerActiveLearningWorkflow.StepType.REPORT_PAIRS;
  }
  ...
  public ReportImprovedPairsStep setProjectId(String projectId) {
  ...
  public String toString() {
    return "ReportImprovedPairsStep{" +
