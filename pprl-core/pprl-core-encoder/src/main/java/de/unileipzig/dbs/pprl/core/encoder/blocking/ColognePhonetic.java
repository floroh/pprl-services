...
public class ColognePhonetic extends SingleAttributeBlocker {

  private static org.apache.commons.codec.language.ColognePhonetic encoder =
    new org.apache.commons.codec.language.ColognePhonetic();

  public ColognePhonetic(String id, String attributeKey) {
  ...
  public static Optional<String> encode(String in) {
    return Optional.ofNullable(encoder.encode(in));
  }
}
