...
/**
 * Split a single attribute value into multiple parts.
 ...
 * @param <O> type of the output attributes
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.MINIMAL_CLASS, property = "@class")
public interface AttributeSplitter<I, O> {

  List<O> preprocess(I value);
