...
/******************************************************************************
 * File: RandomGenerator.AliasMethod.java
...
public final class AliasMethod {
  ...
  /**
   * Constructs a new RandomGenerator.AliasMethod to sample from a discrete distribution and
  ...
  public AliasMethod(List<Double> probabilities) {
    this(probabilities, RandomSingleton.getRandom());
  }
